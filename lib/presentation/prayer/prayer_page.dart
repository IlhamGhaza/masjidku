      ...
      if (permissionStatus) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                AppLocalizations.of(context)!.loc_per_denied,
      ...
      builder: (context, themeMode) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            title: Text(
              AppLocalizations.of(context)!.prayer_times,
            ...
            actions: [
              IconButton(
                ...
                tooltip: AppLocalizations.of(context)!.select_date,
              ),
              IconButton(
                onPressed: () {
                  refreshLocation();
                ...
                tooltip: AppLocalizations.of(context)!.refresh_location,
              ),
            ],
          ),
          body: SafeArea(
    ...
    try {
      ...
      final alarmSettings = AlarmSettings(
        ...
        notificationSettings: NotificationSettings(
          ...
          body:
              '${AppLocalizations.of(context)!.its_time_for} $prayerName ${AppLocalizations.of(context)!.prayer_at} $timeString',
          stopButton: AppLocalizations.of(context)!.stop,
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '${AppLocalizations.of(context)!.alarm_set} $prayerName at $timeString',
            style: TextStyle(color: Colors.white),
          ),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '${AppLocalizations.of(context)!.alarm_error}: $e',
            style: TextStyle(color: Colors.white),
          ),
          backgroundColor: Colors.red,
          behavior: SnackBarBehavior.floating,
  ...
  Future<void> _cancelAlarm(String prayerName) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '${AppLocalizations.of(context)!.alarm_canceled} $prayerName',
            style: TextStyle(color: Colors.white),
          ),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            AppLocalizations.of(context)!.cancel_error,
            style: TextStyle(color: Colors.white),
          ),
          backgroundColor: Colors.red,
          behavior: SnackBarBehavior.floating,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(
            isAlarmSet
                ? '${AppLocalizations.of(context)!.manage_alarm_for} $prayerName'
                : '${AppLocalizations.of(context)!.set_alarm_for} $prayerName',
          ),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              if (!isAlarmSet)
                Text(
                  '${AppLocalizations.of(context)!.would_you_like_to_set_alarm} $prayerName at $time?',
                ),
              if (isAlarmSet)
                Text('${AppLocalizations.of(context)!.alarm_already_set} $prayerName at $time'),
              const SizedBox(height: 16),
              Row(
                children: [
                  Icon(Icons.access_time, size: 18, color: colorScheme.primary),
                  const SizedBox(width: 8),
                  Text('${AppLocalizations.of(context)!.prayer_time} $time'),
                ],
              ),
            ],
          ),
          actions: [
            ...
            if (!isAlarmSet)
              ElevatedButton(
                ...
                child: Text(AppLocalizations.of(context)!.set_alarm),
              ),
            if (isAlarmSet)
              ElevatedButton(
                onPressed: () {
                ...
                child: Text(AppLocalizations.of(context)!.cancel_alarm),
              ),
          ],
        );
      },
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                AppLocalizations.of(context)!.next_prayer,
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context)!.alarm_set,
                        style: TextStyle(
                          fontSize: 12,
                          color: Colors.orange,
                          fontWeight: FontWeight.bold,
          ...
          ElevatedButton.icon(
            ...
            label: Text(
              isAlarmSet
                  ? AppLocalizations.of(context)!.cancel_next_prayer_alarm
                  : AppLocalizations.of(context)!.set_next_prayer_alarm,
