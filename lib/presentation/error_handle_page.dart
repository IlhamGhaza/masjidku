...
class ErrorHandlerPage extends StatefulWidget {
  ...
  const ErrorHandlerPage({super.key, this.errorDetails, required this.onRetry});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Error message
                    Text(
                          AppLocalizations.of(context)!.app_encountered_error,
                          style: TextStyle(
                            fontSize: 16,
                    ...
                    Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 16),
                              Text(
                                AppLocalizations.of(context)!.please_restart_app,
                                style: TextStyle(
                                  fontSize: 16,
                              ...
                              Text(
                                AppLocalizations.of(context)!.we_apologize_for_inconvenience,
                                style: TextStyle(
                                  fontSize: 14,
